...
import com.zee.brewery.service.BeerService;
...
class BeerControllerTest {
    ...
    void getBeer() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/beer/" + validBeer.getId()).accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.beerName", is("DRINKS")));
    ...
    void deleteBeer() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/beer/" + UUID.randomUUID()).content(beerDtoJson)).andExpect(status().isNoContent());
